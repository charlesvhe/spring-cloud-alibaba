 ...
 */
@Component
public class EurekaEventListener implements ApplicationListener {
    ...
    private Instance getNacosInstanceFromEureka(InstanceInfo instanceInfo) {
        ...
        metadata.put(METADATA_DISCOVERY_CLIENT, ProxyConstants.EUREKA_VALUE);
    ...
    private boolean isFromNacos(InstanceInfo instanceInfo) {
        String discoveryClient = instanceInfo.getMetadata().get(METADATA_DISCOVERY_CLIENT);
